                                    ...
                                    <div className="right-side">
                                        <div className="border">
                                            <div className="bars">
                                                ...
                                                ></div>
                                                <div
                                                    className={`bar bar2--${song.difficulty.toLowerCase()}`}
                                                ></div>
                                                <div
                                                    className={`bar bar3--${song.difficulty.toLowerCase()}`}
                                                ></div>
                                                <div
                                                    className={`bar bar4--${song.difficulty.toLowerCase()}`}
                                                ></div>
                                            </div>
                                    ...
                                    <div className="right-side">
                                        <div className="border">
                                            <div className="bars">
                                                ...
                                                ></div>
                                                <div
                                                    className={`bar bar2--${songInfo.difficulty.toLowerCase()}`}
                                                ></div>
                                                <div
                                                    className={`bar bar3--${songInfo.difficulty.toLowerCase()}`}
                                                ></div>
                                                <div
                                                    className={`bar bar4--${songInfo.difficulty.toLowerCase()}`}
                                                ></div>
                                            </div>
                                            <p className="difficulty">
                                                {songInfo.difficulty}
                                ...
                                <div className="video">
                                    <iframe
                                        src={
                                            songInfo
                                                ? `${songInfo.preview}${
                                                      !songInfo.preview.includes(
                                                          "?"
                                                      )
                                                          ? "?"
                                                          : "&"
                                                  }modestbranding=1&autohide=1&showinfo=0&rel=0&loop=1`
                                                : ""
                                        }
                                        frameBorder={"0"}
                                        allow={
                                            "accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; modestbranding"
                                        }
                                        allowFullScreen
                                    ></iframe>
                                </div>
